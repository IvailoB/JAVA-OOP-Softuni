...
public class DummyTest {
    ...
    public void test_DeadDummy_CannotBeAttack() {
        deadDummy.takeAttack(ATTACK_POINTS);
    }

    @Test
    public void test_DeadDummy_Gives_EX() {
        int actual = deadDummy.giveExperience();
        assertEquals(EXPERIENCE,actual);
    }

    @Test(expected = IllegalStateException.class)
    public void test_AliveDummy_CannotGive_EX() {
    ...
    @Test
    public void test_DeadDummy_IsAlive() {
